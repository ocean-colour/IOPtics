...
This prompt doc will be used to update the websites for the IOPtics GitHub Repository.  This includes both the GitHub facing site -- `https://github.com/ocean-colour/IOPtics` -- and the Read the Docs site -- `https://ioptics.readthedocs.io/en/first-go/`
...
3. Read this file.  Execute the 3rd task under "GitHub Website"
...
1. Let's improve the GitHub website via our README.md file. Please:
    ...
    - Add the developer names: J. Xavier Prochaska 
