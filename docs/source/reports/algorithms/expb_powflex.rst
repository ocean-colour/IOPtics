================================
Algorithm profile — expb_powflex
================================

In one paragraph
----------------

``expb_powflex`` has scoreable results on **GLORIA** across 1 sweep(s). Its best contest is a_dg(440) on GLORIA, at mae 0.753 (75.3% multiplicative error); its worst is a_dg(440) on GLORIA at 1.41. It produced a usable fit for 14%-86% of the spectra it was given, depending on the dataset — read that together with the accuracy, since a good score over few spectra is not a better algorithm than a fair score over all of them.
...
.. list-table:: expb_powflex — scored contests
   :header-rows: 1
   :widths: auto
...
.. list-table:: expb_powflex — interval calibration
   :header-rows: 1
   :widths: auto
...
.. list-table:: expb_powflex — pairwise verdicts
   :header-rows: 1
   :widths: auto
