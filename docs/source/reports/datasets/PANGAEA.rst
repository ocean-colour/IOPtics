...
.. list-table:: PANGAEA — who leads where
   :header-rows: 1
   :widths: auto
...
.. list-table:: PANGAEA — why rows were or were not scored
   :header-rows: 1
   :widths: auto
...
.. list-table:: PANGAEA — per trophic stratum
   :header-rows: 1
   :widths: auto
...
(79 further rows are on the :doc:`/reports/leaderboard_full` page.)

Head-to-head
------------

.. list-table:: PANGAEA — pairwise verdicts
   :header-rows: 1
   :widths: auto
